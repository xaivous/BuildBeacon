...
namespace BuildBeacon.Patches
{
    ...
    /// They only fire for objects carrying a BeaconController and only log, so they are safe to leave in.
    /// </summary>
    internal static class DiagnosticPatches
    {
        ...
        /// <summary>
        /// Dev mode: how long the local player's inventory change handling takes, vanilla work included, when it takes
        ...
        internal static class Player_OnInventoryChanged
        {
            ...
            {
                if (__instance != Player.m_localPlayer || !BuildBeaconPlugin.Cfg.DevMode.Value) return;
